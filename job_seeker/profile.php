...
if (!isset($_SESSION['username']) || !isset($_SESSION['email'])) {
    header('Location: /Techfit/Techfit/login.php');
    exit();
}
...
<body>
    ...
    <main>
        <section id="profile">
            <img src="/Techfit/Techfit/images/testprofile.png" alt="Your Profile" class="profile-image" />
            <div class="profile-details">
                <h2>Edit Profile</h2>
                <div class="detail-line">
                    <i class="fas fa-user"></i>
                    <span><?php echo htmlspecialchars($username); ?></span>
                    <button class="edit-button"><i class="fas fa-edit"></i> Edit Username</button>
                </div>
                <div class="detail-line">
                    <i class="fas fa-envelope"></i>
                    <span><?php echo htmlspecialchars($email); ?></span>
                    <button class="edit-button"><i class="fas fa-edit"></i> Edit Email</button>
                </div>
                <div class="detail-line">
                    <i class="fas fa-lock"></i>
                    <span>Password</span>
                    <button class="edit-button"><i class="fas fa-edit"></i> Edit Password</button>
                </div>
        ...
        <div class="footer-content">
            <div class="footer-left">
                <div class="footer-logo">
                    <a href="/Techfit/Techfit/index.html"><img src="/Techfit/Techfit/images/logo.jpg" alt="TechFit Logo"></a>
                </div>
                <div class="social-media">
                    <p>Keep up with TechFit:</p>
                    <div class="social-icons">
                        <a href="https://facebook.com"><img src="/Techfit/Techfit/images/facebook.png" alt="Facebook"></a>
                        <a href="https://twitter.com"><img src="/Techfit/Techfit/images/twitter.png" alt="Twitter"></a>
                        <a href="https://instagram.com"><img src="/Techfit/Techfit/images/instagram.png" alt="Instagram"></a>
                        <a href="https://linkedin.com"><img src="/Techfit/Techfit/images/linkedin.png" alt="LinkedIn"></a>
                    </div>
